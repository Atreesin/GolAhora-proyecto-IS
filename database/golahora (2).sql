...
INSERT INTO golahora2.paises (nombre) values ("Argentina");
INSERT INTO golahora2.provincias (id_pais, nombre) values (1, "Buenos Aires");
INSERT INTO golahora2.ciudades (id_provincia, nombre) values (1, "Florencio Varela");
INSERT INTO golahora2.localidades (id_ciudad, nombre) values (1, "Florencio Varela");
INSERT INTO golahora2.direcciones (calle, numero, codigo_postal, id_localidad) values ("calle test", "123", "cp", 1);
INSERT INTO golahora2.clubes (nombre, cuit, num_telefonico, email, id_direccion) values ("El buen deporte", "20-11111111-1", "1155555555", "mail@golahora.com", 1);

SELECT pr.id_provincia, pr.nombre, pa.nombre AS pais FROM provincias pr LEFT JOIN paises pa ON pr.id_pais = pa.id_pais WHERE pa.nombre = "Argentina";
