...
//consultar clientes
const selectUserByEmailOrDni = 'SELECT u.username, u.nombre, u.apellido, n.nombre AS nacionalidad, u.dni, g.genero, u.fecha_nacimiento, u.telefono, u.email, u.user_level FROM users u LEFT JOIN paises n ON u.nacionalidad = n.id_pais LEFT JOIN generos g ON u.genero = g.id_genero WHERE u.email = ? or u.dni = ?';
...
const selectUsersByGenero = 'SELECT u.username, u.nombre, u.apellido, n.nombre AS nacionalidad, u.dni, g.genero, u.telefono, u.email FROM users u LEFT JOIN paises n ON u.nacionalidad = n.id_pais LEFT JOIN generos g ON u.genero = g.id_genero WHERE g.nombre = ? ORDER BY apellido ASC, nombre ASC, dni ASC';
const selectUsersByNacionalidad = 'SELECT u.username, u.nombre, u.apellido, n.nombre AS nacionalidad, u.dni, g.genero, u.telefono, u.email FROM users u LEFT JOIN paises n ON u.nacionalidad = n.id_pais LEFT JOIN generos g ON u.genero = g.id_genero WHERE n.nombre = ? ORDER BY apellido ASC, nombre ASC, dni ASC';
const selectAllUsers = 'SELECT u.username, u.nombre, u.apellido, n.nombre AS nacionalidad, u.dni, g.genero, u.telefono, u.email FROM users u LEFT JOIN paises n ON u.nacionalidad = n.id_pais LEFT JOIN generos g ON u.genero = g.id_genero ORDER BY apellido ASC, nombre ASC, dni ASC';
const selectAllUsersLimit = 'SELECT u.username, u.nombre, u.apellido, n.nombre AS nacionalidad, u.dni, g.genero, u.telefono, u.email FROM users u LEFT JOIN paises n ON u.nacionalidad = n.id_pais LEFT JOIN generos g ON u.genero = g.id_genero ORDER BY apellido ASC, nombre ASC, dni ASC LIMIT ? OFFSET ?';
