...
//const selectFullUserById = `SELECT u.username, u.nombre, u.apellido, u.dni, n.nombre AS nacionalidad, g.genero, DATE_FORMAT(u.fecha_nacimiento, '%Y-%m-%d') AS fecha_nacimiento, u.email, u.telefono, DATE(CONVERT_TZ(u.fecha_registro, '+00:00', '-03:00')) AS fecha_registro, d.calle, d.numero, d.codigo_postal, l.nombre AS localidad, ci.nombre AS ciudad, pr.nombre AS provincia, pa.nombre AS pais, JSON_OBJECT('id', c.id_club,'nombre', c.nombre) AS club, u.user_level FROM usuarios u LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN paises n ON n.id_pais = u.id_nacionalidad LEFT JOIN direcciones d ON u.id_direccion = d.id_direccion LEFT JOIN localidades l ON d.id_localidad = l.id_localidad LEFT JOIN ciudades ci ON ci.id_ciudad = l.id_ciudad LEFT JOIN provincias pr ON pr.id_provincia = ci.id_provincia LEFT JOIN paises pa ON pa.id_pais = pr.id_pais LEFT JOIN clubes c ON c.id_club = u.id_club WHERE u.id_usuario = ?';
const selectFullUserById = `SELECT u.username, u.nombre, u.apellido, u.dni, n.nombre AS nacionalidad, g.genero, DATE_FORMAT(u.fecha_nacimiento, '%Y-%m-%d') AS fecha_nacimiento, u.email, u.telefono, DATE(CONVERT_TZ(u.fecha_registro, '+00:00', '-03:00')) AS fecha_registro, JSON_OBJECT('calle', d.calle,'numero', d.numero,'cp', d.codigo_postal,'localidad', l.nombre,'ciudad', ci.nombre,'provincia', pr.nombre,'pais', pa.nombre) AS direccion, JSON_OBJECT('id', c.id_club,'nombre', c.nombre) AS club, u.user_level FROM usuarios u LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN paises n ON n.id_pais = u.id_nacionalidad LEFT JOIN direcciones d ON u.id_direccion = d.id_direccion LEFT JOIN localidades l ON d.id_localidad = l.id_localidad LEFT JOIN ciudades ci ON ci.id_ciudad = l.id_ciudad LEFT JOIN provincias pr ON pr.id_provincia = ci.id_provincia LEFT JOIN paises pa ON pa.id_pais = pr.id_pais LEFT JOIN clubes c ON c.id_club = u.id_club WHERE u.id_usuario = ?`;
//const selectFullUserByEmail = `SELECT u.id_usuario AS id, u.username, u.nombre, u.apellido, u.dni, n.nombre AS nacionalidad, g.genero, DATE_FORMAT(u.fecha_nacimiento, '%Y-%m-%d') AS fecha_nacimiento, u.email, u.telefono, DATE(CONVERT_TZ(u.fecha_registro, '+00:00', '-03:00')) AS fecha_registro, d.calle, d.numero, d.codigo_postal, l.nombre AS localidad, ci.nombre AS ciudad, pr.nombre AS provincia, pa.nombre AS pais, JSON_OBJECT('id', c.id_club,'nombre', c.nombre) AS club, u.user_level FROM usuarios u LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN paises n ON n.id_pais = u.id_nacionalidad LEFT JOIN direcciones d ON u.id_direccion = d.id_direccion LEFT JOIN localidades l ON d.id_localidad = l.id_localidad LEFT JOIN ciudades ci ON ci.id_ciudad = l.id_ciudad LEFT JOIN provincias pr ON pr.id_provincia = ci.id_provincia LEFT JOIN paises pa ON pa.id_pais = pr.id_pais LEFT JOIN clubes c ON c.id_club = u.id_club WHERE u.email = ?';
const selectFullUserByEmail = `SELECT u.id_usuario AS id, u.username, u.nombre, u.apellido, u.dni, n.nombre AS nacionalidad, g.genero, DATE_FORMAT(u.fecha_nacimiento, '%Y-%m-%d') AS fecha_nacimiento, u.email, u.telefono, DATE(CONVERT_TZ(u.fecha_registro, '+00:00', '-03:00')) AS fecha_registro, JSON_OBJECT('calle', d.calle,'numero', d.numero,'cp', d.codigo_postal,'localidad', l.nombre,'ciudad', ci.nombre,'provincia', pr.nombre,'pais', pa.nombre) AS direccion, JSON_OBJECT('id', c.id_club,'nombre', c.nombre) AS club, u.user_level FROM usuarios u LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN paises n ON n.id_pais = u.id_nacionalidad LEFT JOIN direcciones d ON u.id_direccion = d.id_direccion LEFT JOIN localidades l ON d.id_localidad = l.id_localidad LEFT JOIN ciudades ci ON ci.id_ciudad = l.id_ciudad LEFT JOIN provincias pr ON pr.id_provincia = ci.id_provincia LEFT JOIN paises pa ON pa.id_pais = pr.id_pais LEFT JOIN clubes c ON c.id_club = u.id_club WHERE u.email = ?`;
//const selectFullUserByDni = `SELECT u.id_usuario AS id, u.username, u.nombre, u.apellido, u.dni, n.nombre AS nacionalidad, g.genero, DATE_FORMAT(u.fecha_nacimiento, '%Y-%m-%d') AS fecha_nacimiento, u.email, u.telefono, DATE(CONVERT_TZ(u.fecha_registro, '+00:00', '-03:00')) AS fecha_registro, d.calle, d.numero, d.codigo_postal, l.nombre AS localidad, ci.nombre AS ciudad, pr.nombre AS provincia, pa.nombre AS pais, JSON_OBJECT('id', c.id_club,'nombre', c.nombre) AS club, u.user_level FROM usuarios u LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN paises n ON n.id_pais = u.id_nacionalidad LEFT JOIN direcciones d ON u.id_direccion = d.id_direccion LEFT JOIN localidades l ON d.id_localidad = l.id_localidad LEFT JOIN ciudades ci ON ci.id_ciudad = l.id_ciudad LEFT JOIN provincias pr ON pr.id_provincia = ci.id_provincia LEFT JOIN paises pa ON pa.id_pais = pr.id_pais LEFT JOIN clubes c ON c.id_club = u.id_club WHERE u.dni LIKE ? ORDER BY u.apellido, u.nombre';
const selectFullUserByDni = `SELECT u.id_usuario AS id, u.username, u.nombre, u.apellido, u.dni, n.nombre AS nacionalidad, g.genero, DATE_FORMAT(u.fecha_nacimiento, '%Y-%m-%d') AS fecha_nacimiento, u.email, u.telefono, DATE(CONVERT_TZ(u.fecha_registro, '+00:00', '-03:00')) AS fecha_registro, JSON_OBJECT('calle', d.calle,'numero', d.numero,'cp', d.codigo_postal,'localidad', l.nombre,'ciudad', ci.nombre,'provincia', pr.nombre,'pais', pa.nombre) AS direccion, JSON_OBJECT('id', c.id_club,'nombre', c.nombre) AS club, u.user_level FROM usuarios u LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN paises n ON n.id_pais = u.id_nacionalidad LEFT JOIN direcciones d ON u.id_direccion = d.id_direccion LEFT JOIN localidades l ON d.id_localidad = l.id_localidad LEFT JOIN ciudades ci ON ci.id_ciudad = l.id_ciudad LEFT JOIN provincias pr ON pr.id_provincia = ci.id_provincia LEFT JOIN paises pa ON pa.id_pais = pr.id_pais LEFT JOIN clubes c ON c.id_club = u.id_club WHERE u.dni LIKE ? ORDER BY u.apellido, u.nombre`;
//const selectFullUserByApellido = `SELECT u.id_usuario AS id, u.username, u.nombre, u.apellido, u.dni, n.nombre AS nacionalidad, g.genero, DATE_FORMAT(u.fecha_nacimiento, '%Y-%m-%d') AS fecha_nacimiento, u.email, u.telefono, DATE(CONVERT_TZ(u.fecha_registro, '+00:00', '-03:00')) AS fecha_registro, d.calle, d.numero, d.codigo_postal, l.nombre AS localidad, ci.nombre AS ciudad, pr.nombre AS provincia, pa.nombre AS pais, JSON_OBJECT('id', c.id_club,'nombre', c.nombre) AS club, u.user_level FROM usuarios u LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN paises n ON n.id_pais = u.id_nacionalidad LEFT JOIN direcciones d ON u.id_direccion = d.id_direccion LEFT JOIN localidades l ON d.id_localidad = l.id_localidad LEFT JOIN ciudades ci ON ci.id_ciudad = l.id_ciudad LEFT JOIN provincias pr ON pr.id_provincia = ci.id_provincia LEFT JOIN paises pa ON pa.id_pais = pr.id_pais LEFT JOIN clubes c ON c.id_club = u.id_club WHERE u.apellido LIKE ? ORDER BY u.apellido, u.nombre';
const selectFullUserByApellido = `SELECT u.id_usuario AS id, u.username, u.nombre, u.apellido, u.dni, n.nombre AS nacionalidad, g.genero, DATE_FORMAT(u.fecha_nacimiento, '%Y-%m-%d') AS fecha_nacimiento, u.email, u.telefono, DATE(CONVERT_TZ(u.fecha_registro, '+00:00', '-03:00')) AS fecha_registro, JSON_OBJECT('calle', d.calle,'numero', d.numero,'cp', d.codigo_postal,'localidad', l.nombre,'ciudad', ci.nombre,'provincia', pr.nombre,'pais', pa.nombre) AS direccion, JSON_OBJECT('id', c.id_club,'nombre', c.nombre)AS club, u.user_level FROM usuarios u LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN paises n ON n.id_pais = u.id_nacionalidad LEFT JOIN direcciones d ON u.id_direccion = d.id_direccion LEFT JOIN localidades l ON d.id_localidad = l.id_localidad LEFT JOIN ciudades ci ON ci.id_ciudad = l.id_ciudad LEFT JOIN provincias pr ON pr.id_provincia = ci.id_provincia LEFT JOIN paises pa ON pa.id_pais = pr.id_pais LEFT JOIN clubes c ON c.id_club = u.id_club WHERE u.apellido LIKE ? ORDER BY u.apellido, u.nombre`;
