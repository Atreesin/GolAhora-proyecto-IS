...
const selectAllUserByLevel = 'SELECT u.username, u.nombre, u.apellido, n.nombre AS nacionalidad, u.dni, g.genero, u.telefono, u.email, c.nombre AS club  FROM usuarios u LEFT JOIN paises n ON u.id_nacionalidad = n.id_pais LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN clubes c ON c.id_club = u.id_club WHERE user_level = ? ORDER BY apellido ASC, nombre ASC, dni ASC';
...
const selectFullUserByEmail = 'SELECT u.username, u.nombre, u.apellido, u.dni, n.nombre AS nacionalidad, g.genero, u.fecha_nacimiento, u.email, u.telefono, u.fecha_registro, d.calle, d.numero, d.codigo_postal, l.nombre AS localidad, ci.nombre AS ciudad, pr.nombre AS provincia, pa.nombre AS pais, c.nombre AS club, u.user_level, u.fecha_registro FROM usuarios u LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN paises n ON n.id_pais = u.id_nacionalidad LEFT JOIN direcciones d ON u.id_direccion = d.id_direccion LEFT JOIN localidades l ON d.id_localidad = l.id_localidad LEFT JOIN ciudades ci ON ci.id_ciudad = l.id_ciudad LEFT JOIN provincias pr ON pr.id_provincia = ci.id_provincia LEFT JOIN paises pa ON pa.id_pais = pr.id_pais JOIN clubes c ON c.id_club = u.id_club WHERE u.email = ?';
const selectFullUserByDni = 'SELECT u.username, u.nombre, u.apellido, u.dni, n.nombre AS nacionalidad, g.genero, u.fecha_nacimiento, u.email, u.telefono, u.fecha_registro, d.calle, d.numero, d.codigo_postal, l.nombre AS localidad, ci.nombre AS ciudad, pr.nombre AS provincia, pa.nombre AS pais, c.nombre AS club, u.user_level, u.fecha_registro FROM usuarios u LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN paises n ON n.id_pais = u.id_nacionalidad LEFT JOIN direcciones d ON u.id_direccion = d.id_direccion LEFT JOIN localidades l ON d.id_localidad = l.id_localidad LEFT JOIN ciudades ci ON ci.id_ciudad = l.id_ciudad LEFT JOIN provincias pr ON pr.id_provincia = ci.id_provincia LEFT JOIN paises pa ON pa.id_pais = pr.id_pais JOIN clubes c ON c.id_club = u.id_club WHERE u.dni LIKE ? ORDER BY u.apellido, u.nombre';
const selectFullUserByApellido = 'SELECT u.username, u.nombre, u.apellido, u.dni, n.nombre AS nacionalidad, g.genero, u.fecha_nacimiento, u.email, u.telefono, u.fecha_registro, d.calle, d.numero, d.codigo_postal, l.nombre AS localidad, ci.nombre AS ciudad, pr.nombre AS provincia, pa.nombre AS pais, c.nombre AS club, u.user_level, u.fecha_registro FROM usuarios u LEFT JOIN generos g ON u.id_genero = g.id_genero LEFT JOIN paises n ON n.id_pais = u.id_nacionalidad LEFT JOIN direcciones d ON u.id_direccion = d.id_direccion LEFT JOIN localidades l ON d.id_localidad = l.id_localidad LEFT JOIN ciudades ci ON ci.id_ciudad = l.id_ciudad LEFT JOIN provincias pr ON pr.id_provincia = ci.id_provincia LEFT JOIN paises pa ON pa.id_pais = pr.id_pais JOIN clubes c ON c.id_club = u.id_club WHERE u.apellido LIKE ? ORDER BY u.apellido, u.nombre';
