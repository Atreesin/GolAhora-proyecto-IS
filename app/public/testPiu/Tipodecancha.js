...
// ... (Aquí arriba va la clase Cancha que ya tenías bien armada)
    ...
    fetch(API_URL)
        ...
        .then(datosCrudos => {
            ...
            datosCrudos.forEach(data => {
                // ASIGNACIÓN CORRECTA: Usamos las propiedades reales que vienen de tu base de datos
            ...
            console.log("¡Tarjetas creadas con éxito!", listaCanchasObjetos);
        })
        .catch(error => {
